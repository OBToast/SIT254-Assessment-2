...
func save_settings() -> void:
	...
	config.set_value("settings", "color_one", color_picker_button.color)
	config.set_value("settings", "color_two", color_picker_button_2.color)
	config.set_value("settings", "pixelation", pixelation.value)
	config.set_value("settings", "sensitivity", mouse_sensitivity)
	config.set_value("settings", "difficulty", difficulty_level)
...
func load_settings() -> void:
	...
	# Difficulty
	var diff: String = config.get_value("settings", "difficulty", "Medium")
